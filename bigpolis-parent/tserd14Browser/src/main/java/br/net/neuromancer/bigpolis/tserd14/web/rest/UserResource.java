...
import br.net.neuromancer.bigpolis.tserd14.domain.Authority;
import br.net.neuromancer.bigpolis.tserd14.domain.User;
import br.net.neuromancer.bigpolis.tserd14.repository.AuthorityRepository;
import br.net.neuromancer.bigpolis.tserd14.repository.UserRepository;
import br.net.neuromancer.bigpolis.tserd14.repository.search.UserSearchRepository;
import br.net.neuromancer.bigpolis.tserd14.security.AuthoritiesConstants;
import br.net.neuromancer.bigpolis.tserd14.service.MailService;
import br.net.neuromancer.bigpolis.tserd14.service.UserService;
import br.net.neuromancer.bigpolis.tserd14.web.rest.dto.ManagedUserDTO;
import br.net.neuromancer.bigpolis.tserd14.web.rest.dto.UserDTO;
