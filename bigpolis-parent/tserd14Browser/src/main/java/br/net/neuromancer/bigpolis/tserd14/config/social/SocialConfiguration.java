package br.net.neuromancer.bigpolis.tserd14.config.social;

import br.net.neuromancer.bigpolis.tserd14.repository.SocialUserConnectionRepository;
import br.net.neuromancer.bigpolis.tserd14.repository.CustomSocialUsersConnectionRepository;
import br.net.neuromancer.bigpolis.tserd14.security.social.CustomSignInAdapter;
