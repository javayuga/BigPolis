package br.net.neuromancer.bigpolis.tserd14.config;

import br.net.neuromancer.bigpolis.tserd14.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("br.net.neuromancer.bigpolis.tserd14.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("br.net.neuromancer.bigpolis.tserd14.repository.search")
